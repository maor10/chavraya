            ...
            <div class="container" style="text-align:right">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="productbox" >
                        ...
                        <h5>חבריא</h5>
                        אגודת החברים העולים להשתקע בארץ ישראל, שמה לה למטרה, בראש ובראשונה, לגבש קבוצת משפחות חסידיות מקרב העולים, ולהקים בארץ - קהילה מִשֶׁלָה, קהילה נאה וחסודה, באזור נעים ומתאים, עם מוסדות חינוך מתאימים לבניה ולבנותיה.
                    </div>
                    ...
                    <div class="productbox">
                        ...
                        <h5>חבריא</h5>
                        עתידה בעז"ה להרחיב את גבולותיה, על מנת להציב את עצמה ככתובת הנכונה גם לתלמידי הישיבות ותלמידות הסמינרים הבאים בגפם ללמוד בארץ ישראל, לתת להם מענה לכל צרכיהם, הם ברוח והן בגשם, כראוי וכנכון.
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6">
                    <div class="productbox">
                        ...
                        <h5>חבריא</h5>
                        נטלה על עצמה את העול, לדאוג לעזרת הקבוצה. מנהליה יצרו ויוצרים את הקשרים הנכונים, על מנת לאפשר את העזרה המקסימלית להקל על העליה ועל צרכיה המרובים, כגון דיור, עבודה, חינוך, יחד עם הקמת בית המדרש ומרכז הקהילה הנעימה, שתאחד את כולם למשפחה אחת גדולה.
                    </div>
                    <div class="productbox">
                        <div>
                        ...
                        <h5>חבריא</h5>
                        משתדלת לעזור ולסייע גם לשאר קבוצות או יחידים, העולים ארצה ובוחרים לגור במקומות שונים בארץ, חבריא מושיטה את ידה עד אליהם, למען יוכלו גם הם להנות מהעזרה העצומה ולקבל את הסיוע המגיע להם להקלת העליה.
                    </div>
